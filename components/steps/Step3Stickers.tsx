...
export default function Step3Stickers({ onBack, onNext }: Props) {
  const { coverImagePreviewUrl, coverImageLayout, trackTextColor, stickers, name, toggleSticker, tracks } = useVinylStore()
    ...
    <div className="flex flex-col items-center w-full px-4">
      ...
      <div className="w-full flex justify-center">
        <div className="sm:hidden">
          <VinylCover coverImageUrl={coverImagePreviewUrl} coverImageLayout={coverImageLayout} trackTextColor={trackTextColor} stickers={stickers} name={name} tracks={tracks} size={280} />
        </div>
        <div className="hidden sm:block">
          <VinylCover coverImageUrl={coverImagePreviewUrl} coverImageLayout={coverImageLayout} trackTextColor={trackTextColor} stickers={stickers} name={name} tracks={tracks} size={420} />
        </div>
      </div>
